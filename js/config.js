...
window.els = {
  ...
  headerPageInput: document.getElementById("header-page-input"),
  ...
  pageProgressContainer: document.getElementById("page-progress-container"),
  pageProgress: document.getElementById("page-progress"),
  mainContent: document.getElementById("main-content"),
  appContainer: document.getElementById("app-container"),
  ayahCard: document.getElementById("ayah-card"),
  spreadCard: document.getElementById("spread-card"),
  spreadView: document.getElementById("spread-view"),
