...
- **Kompatibilnost snimanja (iPhone/iOS)**: Riješen problem gdje se snimci nisu mogli reprodukovati na iPhone uređajima. Aplikacija sada automatski detektuje najbolje podržani format (prioritet na `audio/mp4` za iOS) kako bi osigurala besprijekoran rad na svim platformama.
## [0.0.13] - 2026-03-11

### Added

- **Novi vizuelni identitet snimanja**: Uveden je potpuno novi dizajn za vježbanje i preslušavanje Kur'ana:
  - **Dinamičko dugme za snimanje**: Dugme se sada elegantno širi prilikom snimanja kako bi prikazalo živi tajmer, dok ostala dugmad ("Tačno", "Označi") diskretno ustupaju prostor.
  - **Indikator nivoa mikrofona**: Unutar dugmeta za snimanje dodat je dinamički vizuelni indikator (Mic Meter) u `rose` boji koji se pomjera u realnom vremenu dok korisnik govori.
  - **Rose vizuelna tema**: Cijeli sekciju za korisničke snimke ("Tvoj snimak") sada prati prepoznatljiva `rose-500` boja, uključujući i player za reprodukciju snimka.
- **Kontekstualni indikatori napretka**: Kod Page Badge indikatora dodat je brojač koji pokazuje koliko je ajeta preostalo na trenutnoj stranici (npr. 2/6), što pomaže u boljoj orijentaciji tokom učenja.

### Fixed

- **Mobilna navigacija**: Lebdeći donji meni se sada prikazuje isključivo na pametnim telefonima i mobilnim uređajima, dok na desktop uređajima ostaje skriven.
